...
export const user = pgTable("user", {
  ...
  image: text("image"),
  role: text("role").default("user"), // comma-separated app roles: user, ambassador, partner, moderator, admin
  ...
  profileEffects: jsonb("profile_effects").$type<StoredProfileEffects>(),
