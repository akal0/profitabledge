...
- `apps/web/src/app/(dashboard)/dashboard/growth-admin/page.tsx`
...
- the Growth sidebar section now includes a dedicated growth overview route plus a separate growth-admin route for beta codes, waitlist review, affiliate approvals, and affiliate payouts
