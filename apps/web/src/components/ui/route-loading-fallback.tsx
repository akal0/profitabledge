...
const ROUTE_LOADING_COPY = {
  ...
  backtestAnalytics: "Crunching the simulations and lining up the analytics...",
  backtestCompare: "Stacking your backtests against live performance...",
  backtestReplay: "Resetting the candles and rebuilding the replay desk...",
  backtestReview: "Rebuilding the replay journal and your session notes...",
  backtestSessions: "Pulling together your saved replay sessions...",
